      ...
      <div className="sticky top-0 z-50 w-full bg-zinc-950/95 border-b border-zinc-800 backdrop-blur-md px-4 py-2.5 flex items-center justify-between shadow-xl">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="text-xs font-semibold px-3 py-1.5 rounded-lg bg-zinc-900 border border-zinc-800 text-purple-300 hover:text-white hover:bg-zinc-800 transition-colors flex items-center gap-1.5"
          >
